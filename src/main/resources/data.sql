...
('雪国', '川端康成', 'UNREAD', 0, 220, '新潟の温泉地を舞台にした男女の物語', '情景描写が美しいと評判'),
('人間失格', '太宰治', 'READING', 45, 180, '主人公の生きづらさと孤独を描いた自伝的作品', '重い内容だが引き込まれる'),
('舞姫', '森鴎外', 'UNREAD', 0, 160, 'ドイツ留学中の青年と舞姫の悲恋を描いた作品', '明治時代の異文化交流が興味深い'),
('山月記', '中島敦', 'UNREAD', 0, 90, '自尊心と孤独に苦しむ詩人が虎になる物語', '人間の弱さを鋭く描いている');
